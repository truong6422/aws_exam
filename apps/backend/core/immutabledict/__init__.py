...
class ImMutableDict(Mapping[_K, _V]):  # noqa: N801
    ...
    def set(self, key: _K, value: Any) -> ImMutableDict[_K, _V]:
        """
        Return a new :class:`ImMutableDict` where the item at the given key is set to the given value.
        If there is already an item at the given key it will be replaced.
