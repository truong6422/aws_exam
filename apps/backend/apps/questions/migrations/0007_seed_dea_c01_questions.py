"""
Data migration: seed DEA-C01 questions from exam-data/DEA-C01/questions.json.
"""
import json
import os
...
DATA_FILE = os.path.join(
    ...
    "../../../../..",
    "exam-data/DEA-C01/questions.json",
)

CERT_CODE = "DEA-C01"
CERT_NAME = "AWS Certified Data Engineer - Associate"
CERT_DESCRIPTION = (
    "Validates expertise in ingesting, transforming, and orchestrating data pipelines on AWS. "
    "Covers data ingestion, transformation, orchestration, governance, and security."
)
...
def load_questions(apps, schema_editor):
    ...
    print(f"\n  ✓ Seeded {created_count} DEA-C01 questions into domain '{DEFAULT_DOMAIN}'.")
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ("questions", "0006_seed_soa_c02_questions"),
    ]
