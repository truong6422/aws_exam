"""
Data migration: seed SOA-C02 questions from exam-data/SOA-C02/questions.json.
"""
import json
import os
...
DATA_FILE = os.path.join(
    ...
    "../../../../..",
    "exam-data/SOA-C02/questions.json",
)
...
CERT_DESCRIPTION = (
    ...
    "Covers monitoring, high availability, security, networking, and cost optimization."
)
...
def load_questions(apps, schema_editor):
    ...
    print(f"\n  ✓ Seeded {created_count} SOA-C02 questions into domain '{DEFAULT_DOMAIN}'.")
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ("questions", "0005_seed_dva_c02_questions"),
    ]
